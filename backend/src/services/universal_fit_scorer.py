...
class UniversalFitScorer:
    ...
    async def calculate_universal_fit(
        ...
        """
        Calculate comprehensive Universal Fit Score using Ollama deep analysis.
        Follows strict priority: Responsibilities > Experience > Skills.
        """
        try:
            # Analyze candidate vs JD with Ollama
            ...
            # Fallback to basic scoring if Ollama fails
    ...
    async def _analyze_with_gpt4o(self, candidate_data: Dict, jd_requirements: Dict) -> Dict:
        """
        Use Ollama to perform deep ATS analysis with role classification and dynamic weighting.
        """
...
"""
    ...
    def _fallback_scoring(self, resume_data: Dict, jd_requirements: Dict) -> Dict:
        """
        Fallback scoring if Ollama is unavailable.
        """
        ...
        return {
            ...
            'overall_explanation': 'Fallback scoring used due to Ollama unavailability'
        }
