                  ...
                  <div className="relocation-toggle-group" style={{ display: 'flex', gap: '12px' }}>
                    <button
                      ...
                      style={{
                        ...
                        background: formData.currentlyWorking ? 'var(--color-accent)' : 'rgba(255, 255, 255, 0.5)',
                        color: formData.currentlyWorking ? 'white' : 'var(--color-accent)',
                        fontWeight: '700',
                        cursor: 'pointer',
                        transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                        boxShadow: formData.currentlyWorking ? '0 4px 12px rgba(229, 56, 59, 0.3)' : 'none'
                      }}
                    >
                      Yes
                    </button>
                  ...
                  <div className="relocation-toggle-group" style={{ display: 'flex', gap: '12px' }}>
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: '12px',
                        border: '2px solid var(--color-accent)',
                        background: formData.readyToRelocate ? 'var(--color-accent)' : 'rgba(255, 255, 255, 0.5)',
                        color: formData.readyToRelocate ? 'white' : 'var(--color-accent)',
                        fontWeight: '700',
                        cursor: 'pointer',
                        transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                        boxShadow: formData.readyToRelocate ? '0 4px 12px rgba(229, 56, 59, 0.3)' : 'none'
                      }}
                    >
                      Yes
                    </button>
